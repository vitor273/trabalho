...
@keyframes rotateShadow {
  ...
  100% {
    ...
    <body>
        ...
        <div class="col-xs-12 col-md-6 centered" style="padding-top:20px;">
            <div class="cols">
                <div class="card mb-2 rounded shadow-sw">
                    ...
                    <div class="card-body">
                    <div class="row">
                <div class=".col-lg-12 col-md-3 centered">
                </div>
                <div class="col-xs-12 col-md-7 centered" style="padding-top:20px;">
